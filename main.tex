...
\chapter{Giới thiệu}
\label{c:intro}
\input{chapters/1-GioiThieu}

\chapter{Tổng quan lý thuyết, nghiên cứu liên quan}
\label{c:cosolythuyet}
\input{chapters/2-TongQuanLyThuyetNghienCuuLienQuan}
